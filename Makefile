...
examples/shellcode_hello_world.bin : examples/shellcode_hello_world.o
	$(CXX) $(CPPFLAGS) $(SHELLCODE_FLAGS) $(LDFLAGS) -T ./shellcode_linker.ld -o examples/shellcode_hello_world.bin examples/shellcode_hello_world.o

tests/shellcode_test.out : tests/shellcode_test.o
	$(CXX) $(CPPFLAGS) $(SHELLCODE_TEST_FLAGS) $(LDFLAGS)  -o tests/shellcode_test.out tests/shellcode_test.o


examples/shellcode_hello_world.o:
	$(CXX) $(CPPFLAGS) $(SHELLCODE_FLAGS) -c examples/shellcode_hello_world.cpp -o examples/shellcode_hello_world.o

tests/shellcode_test.o:
	$(CXX) $(CPPFLAGS) $(SHELLCODE_TEST_FLAGS) -c tests/shellcode_test.cpp -o tests/shellcode_test.o
